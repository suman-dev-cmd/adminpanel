...
const Sidebar:React.FC = () => {
    // let moved = true;
    // let sideBar:HTMLElement = document.getElementById("mobile-nav");
    // let toggler = document.getElementById("mobile-toggler");
    // sideBar.style.transform = "translateX(-260px)";sidebarHandler
    ...
    return(
        <>
            ...
            <div className="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-gray-800 flex flex-wrap items-center justify-between relative md:w-64 z-10 py-4 px-6 hidden sm:flex h-screen">
                <div className="px-8">
                    ...
                    <ul className="mt-12">
                        <li className={splitLocation[1] === "" ? "activeClass" : "normalClass"}>
                            <Link to='/'>
                        ...
                        <li className={splitLocation[1] === "product" ? "activeClass" : "normalClass"}>
                            <Link to='/product'>   
                                <div className="flex items-center">
                        ...
                        <li className={splitLocation[1] === "performance" ? "activeClass" : "normalClass"}>
                            <Link to='/performance'> 
                                <div className="flex items-center">
                        ...
                        <li className={splitLocation[1] === "deliverables" ? "activeClass" : "normalClass"}>
                        ...
                        <li className={splitLocation[1] === "invoice" ? "activeClass" : "normalClass"}>
                            <Link to='/invoice'>
                                <div className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-puzzle" width={18} height={18} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" />
                        ...
                        <li className={splitLocation[1] === "inventory" ? "activeClass" : "normalClass"}>
                            <Link to='/inventory'>
                                <div className="flex items-center">
                        ...
                        <li className={splitLocation[1] === "settings" ? "activeClass" : "normalClass"}>
                            <Link to='/settings'>
                                <div className="flex items-center">
            ...
            <div className="h-10 w-10 bg-gray-800 absolute right-0 mt-5 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer" id="mobile-toggler" onClick={() => setNavbarOpen(!navbarOpen)}>
            ...
            <div className={navbarOpen?"mobileon":"mobileoff"} id="mobile-nav">
                <div className="px-8">
                    <div className="h-16 w-full flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width={144} height={30} viewBox="0 0 144 30">
                            <path
