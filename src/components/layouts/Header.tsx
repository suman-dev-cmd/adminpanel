...
const Header:React.FC<navType> = ({ fixed })=> {
    const [navbarOpen, setNavbarOpen] = React.useState(false);
    return (
      <>
        <nav className="relative flex flex-wrap items-center justify-between px-2 py-3 bg-gray-500 mb-3 mt-0 hidden sm:flex ml-64">
          <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
            <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
                <div className="relative ">
                    <div className="text-white absolute ml-4 inset-0 m-auto w-8 h-4">
                    ...
                    <input className=" bg-gray-500 focus:outline-none rounded w-full text-sm text-white bg-gray-100 pl-10 py-2" type="text" placeholder="Search" />
                </div>
              <button
